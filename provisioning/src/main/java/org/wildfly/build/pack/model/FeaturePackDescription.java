...
public class FeaturePackDescription {
    ...
    private final List<CopyArtifact> artifacts;
    ...
    public FeaturePackDescription(List<String> dependencies, Config config, List<CopyArtifact> artifacts, List<FilePermission> filePermissions) {
    ...
    public List<CopyArtifact> getArtifacts() {
        return artifacts;
    }
